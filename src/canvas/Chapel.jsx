    ...
    return (
        <group {...props} dispose={null}>
            ...
            <mesh geometry={nodes.MainWindow.geometry}>
                <MeshTransmissionMaterial transmission={1} map={purpleOceanTexture} side={2} roughness={0.35}
            ...
            <mesh geometry={nodes.Windows.geometry} ><MeshTransmissionMaterial transmission={1} map={stainedGlassTexture} side={2} roughness={0.35}
                thickness={0.3}
                ior={1.3}
                distortion={1.5}
                distortionScale={0.9}
